  ...
  public: {
    Tables: {
      ...
      games: {
        ...
        Relationships: [
          {
            foreignKeyName: "games_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
      ...
      games_copies: {
        ...
        Relationships: [
          {
            foreignKeyName: "games_copies_business_id_fkey"
            columns: ["business_id"]
            isOneToOne: false
            referencedRelation: "businesses"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "games_copies_game_id_fkey"
            columns: ["game_id"]
            isOneToOne: false
    ...
    Functions: {
      create_game_and_copies: {
        Args: {
          copies_internal_codes: string[]
          game_genre_input: string
          game_name_input: string
